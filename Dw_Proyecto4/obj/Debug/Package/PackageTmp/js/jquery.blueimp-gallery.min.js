! function(t) {
    ...
    return t.extend(e.prototype, {
        ...
        slide: function(t, e) {
            ...
            if (n !== t && 1 !== this.num) {
                if (e || (e = this.options.transitionSpeed), this.support.transform) {
                    for (this.options.continuous || (t = this.circle(t)), i = Math.abs(n - t) / (n - t), this.options.continuous && (s = i, (i = -this.positions[this.circle(t)] / this.slideWidth) !== s && (t = -i * this.num + t)), o = Math.abs(n - t) - 1; o;) o -= 1, this.move(this.circle((t > n ? t : n) - o - 1), this.slideWidth * i, 0);
        ...
        imageFactory: function(e, i) {
            ...
            return "string" != typeof h && (h = this.getItemProperty(e, this.options.urlProperty), l = this.getItemProperty(e, this.options.titleProperty)), !0 === d && (d = "contain"), (d = this.support.backgroundSize && this.support.backgroundSize[d] && d) ? n = this.elementPrototype.cloneNode(!1) : (n = r, r.draggable = !1), l && (n.title = l), t(r).on("load error", s), r.src = h, n
        },
        ...
        getDataProperty: function(e, i) {
            ...
            if (e.dataset ? (s = i.replace(/-([a-z])/g, function(t, e) {
                ...
                }), o = e.dataset[s]) : e.getAttribute && (o = e.getAttribute("data-" + i.replace(/([A-Z])/g, "-$1").toLowerCase())), "string" == typeof o) {
                if (/^(true|false|null|-?\d+(\.\d+)?|\{[\s\S]*\}|\[[\s\S]*\])$/.test(o)) try {
...
function(t) {
    ...
    return t.extend(e.prototype, {
        createIndicator: function(e) {
            ...
            return this.options.thumbnailIndicators && (l && (i = this.getItemProperty(e, l)), void 0 === i && (s = e.getElementsByTagName && t(e).find("img")[0]) && (i = s.src), i && (o.style.backgroundImage = 'url("' + i + '")')), n && (o.title = n), o
        },
...
function(t) {
    ...
    return t.extend(e.prototype, {
        ...
        videoFactory: function(e, i, s) {
            ...
            return v && (y.poster = v, o = this.imagePrototype.cloneNode(!1), t(o).addClass(d.toggleClass), o.src = v, o.draggable = !1, c.appendChild(o)), (l = document.createElement("a")).setAttribute("target", "_blank"), s || l.setAttribute("download", g), l.href = m, y.src && (y.controls = !0, (s || t(y)).on("error", function() {
                h.setTimeout(i, p)
            }).on("pause", function() {
